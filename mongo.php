...
//$MONGO_SERVER = array('host' => 'localhost',
//    'port' => 27017,
//    'dbname' => 'testclient',
//    'user' => '',
//    'pwd' => '');
//
//$host_port = $MONGO_SERVER['host'] . ":" . $MONGO_SERVER['port'];        // 'localhost:27017'
//
...
function mongofind($mongopage, $collection, $sql) {
    ...
    $limit = $mongopage->currentpage * $mongopage->pagesize;
